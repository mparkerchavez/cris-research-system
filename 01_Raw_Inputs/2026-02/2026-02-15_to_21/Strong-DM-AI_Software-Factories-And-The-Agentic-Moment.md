...
The narrative form is included below. If you'd prefer to work from first principles, I offer a few constraints & guidelines that, applied iteratively, will accelerate any team toward the same intuitions, convictions[1](https://factory.strongdm.ai/#fn1), and ultimately a factory[2](https://factory.strongdm.ai/#fn2) of your own. In kōan or mantra form:
...
![Compounding correctness vs compounding error](https://factory.strongdm.ai/images/growth.jpeg)Compounding correctness vs compounding error
...
![These go to 11](https://factory.strongdm.ai/images/eleven.jpg)"These go to 11"
...
![Hands off](https://factory.strongdm.ai/images/no-hand-coded.jpg)Hands off!
...
![Synthetic scenario curation and shaping interface](https://factory.strongdm.ai/images/synthchat.png)Synthetic scenario curation and shaping interface
...
![Okta twin](https://factory.strongdm.ai/images/1-okta.png)![Jira twin](https://factory.strongdm.ai/images/2-jira.png)![Google Docs twin](https://factory.strongdm.ai/images/3-docs.png)![Slack twin](https://factory.strongdm.ai/images/4-slack.png)![Google Drive twin](https://factory.strongdm.ai/images/5-drive.png)![Google Sheets twin](https://factory.strongdm.ai/images/6-sheets.png)
