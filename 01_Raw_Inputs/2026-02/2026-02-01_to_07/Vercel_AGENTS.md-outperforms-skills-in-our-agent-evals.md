...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#the-problem-we-were-trying-to-solve) **The problem we were trying to solve**
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#two-approaches-for-teaching-agents-framework-knowledge) **Two approaches for teaching agents framework knowledge**
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#we-started-by-betting-on-skills) **We started by betting on skills**
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#skills-weren't-being-triggered-reliably) **Skills weren't being triggered reliably**
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#explicit-instructions-helped,-but-wording-was-fragile) **Explicit instructions helped, but wording was fragile**

We tried adding explicit instructions to `AGENTS.md` telling the agent to use the skill.

```text
1Before writing code, first explore the project structure,

2then invoke the nextjs-doc skill for documentation.
```
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#building-evals-we-could-trust) **Building evals we could trust**
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#the-hunch-that-paid-off) **The hunch that paid off**
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#addressing-the-context-bloat-concern) **Addressing the context bloat concern**
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#try-it-yourself) **Try it yourself**
...
## [Link to heading](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals\#what-this-means-for-framework-authors) **What this means for framework authors**
